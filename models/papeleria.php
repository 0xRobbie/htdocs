<?php
    class Papeleria
    {
        ...
        public static function verPapeleria($tipoPapeleria, $soloDepartamento){
            $db = Db::getInstance();          
            $req = $db->query(" SELECT  p.idPapeleria, 
                                        p.producto, 
                                        p.stockMinimo, 
                                        p.minimoSucursal, 
                                        p.maximoSucursal, 
                                        ...
                                        t.tipoPapeleria 
                                FROM papeleria as p
                                LEFT JOIN tipoPapeleria as t ON t.idTipoPapeleria = p.idTipoPapeleria
                                WHERE p.idTipoPapeleria = $tipoPapeleria AND p.soloDepartamento != $soloDepartamento AND p.producto NOT LIKE 'tarjetas%' AND p.producto NOT LIKE 'notas%'
                                ORDER BY p.idPapeleria;");
