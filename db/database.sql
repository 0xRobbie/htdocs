...
-- select * from tipopapeleria;
-- select * from papeleria;
-- select * from formato;
-- select * from usuarios;
-- select * from tipousuario;
-- select * from lugartrabajo;
-- select * from departamentos;
-- select * from sucursales;
-- select * from movimientoconsumibles;
-- select * from folios;

-- delete from papeleria where idPapeleria = 20;
-- delete from papeleria where idPapeleria = 21;
-- delete from papeleria where idPapeleria = 22;
-- delete from papeleria where idPapeleria = 57;
-- delete from papeleria where idPapeleria = 74;
-- delete from papeleria where idPapeleria = 80;
-- delete from papeleria where idPapeleria = 81;
-- delete from papeleria where idPapeleria = 82;
-- delete from papeleria where idPapeleria = 83;
-- delete from papeleria where idPapeleria = 84;
-- delete from papeleria where idPapeleria = 97;
