        ...
        <tbody>
            <?php foreach($departamentos as $departamento) { ?>
                <tr>
                    ...
                    <td> 
                        <a class="btn btn-danger btn-block btn-sm" onclick="return confirm('¿Seguro que quiere eliminar el registro?')" href='?controller=departamentos&action=borrarDepartamentos&idDepartamentos=<?php echo $departamento->getIdDepartamentos() ?>'> 
