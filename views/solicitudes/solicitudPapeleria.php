...
<div class="container">
    ...
    <div class="row">
        <h5>Ingresa las cantidades de productos que necesitas:</h5>
    </div>
                ...
                <?php foreach($papeleria as $producto) { ?>
                    <?php if ($contador == 1) { echo "<div class=\"row\">"; } ?>
                        <div class="col-3">
                            ...
                            <input class="form-control form-control-sm" type="text" name="<?php echo $producto['idPapeleria'] ?>" id="<?php echo $producto['idPapeleria'] ?>" placeholder="<?php echo $producto['formato'] ?>">
                            <br>
                        </div>
